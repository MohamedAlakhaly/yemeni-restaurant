...
import { getCartItems } from "@/lib/localStorage"
...
export default function Menu() {
  ...
  const filteredProducts = products.filter((product) => {
    const matchesCategory = selectedCategory === "Popular" || product.category === selectedCategory
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Tabbar selectedCategory={selectedCategory} onSelectCategory={setSelectedCategory} />
